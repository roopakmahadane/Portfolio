...
return (
    <div id="about" className="min-h-screen bg-[#121212] p-6 mx-auto max-w-4xl font-inter flex flex-col justify-center">
        ...
        <p className="text-lg text-[#b0b0b0] mb-6 w-full font-inter">
        ...
        <p className="text-[#b0b0b0]">Here are a few technologies I’ve been working with recently:</p>
        <div className="grid grid-cols-2 text-[#b0b0b0] max-w-2/3 mt-4">
           <div>
            <p>Solidity</p>
            <p>Javascript</p>
            <p>React</p>
